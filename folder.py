print(" ~~~~~~~~~~~~~~~~~~ ")
print("| Henderson Pizza |")
print("|      Palace     |")
print(" ~~~~~~~~~~~~~~~~~~ ")
print("")

available_pizzas = ['margarita', 'pepperoni', '4cheese', 'bolognese', 'vegetarian', 'hawaiian']
available_toppings = ['mushroom', 'onions', 'green pepper', 'extra cheese']
pizza_prices = {'margarita': 5, 'pepperoni': 7, '4cheese': 6, 'bolognese': 8, 'vegetarian': 6.5, 'hawaiian': 6}
...
#ordering a pizza
print("Welcome to Henderson Pizza Palace")
order_pizza = True
while order_pizza:    
