...
order_pizza = True
while order_pizza:    
    print("Could you please select a pizza that you would like to order from the menu provided: ")
    print()
    ...
    while True:
        ...
        if pizza in pizzas_listed:
            print("You have selected one {pizza} pizza. ")
            finished_price.append(pizza_prices[pizza])
            break
        if pizza not in pizzas_listed:
            print("I'm sorry but unfortunately we do not have {pizza} in our menu please try again. ")

    #asking for extra toppings
    order_topping = True
    print("These are the list of extra toppings that are available to put on your pizza:: ")
    for toppings in toppings_listed:
        print(toppings)
        print()
    while order_topping:
        other_topping = input("Would you like to add any other toppings? yes or no? ")
        if other_topping == "yes" or other_topping == "Yes" or other_topping == "y" or other_topping == "Y":
            ...
            if topping in toppings_listed:
                ...
                print("I have added {topping} onto your pizza. ")
                finished_price.append(topping_prices[topping])
            else:
                print("I am sorry, we don't have {topping} available on our menu please try again. ")
    ...
    if other_pizza == "no" or other_pizza == "No" or other_pizza == "n" or other_pizza == "N" :
        ...
        while check_order:
            print()
            order_correct = input("Is this correct order? yes/no ")
            ...
            if order_correct == "no" or order_correct == "No" or order_correct == "n" or order_correct == "N":
                ...
                add_remove = input("would you like to add or remove anything from your chosen pizzas? ")
...
#finishig of the customers order
print("\nYour total order price is: ${sum(finished_price) + $3 delivery fee }")

print("Could you please provide us with your name, address, postalcode and phonenumber " )
customers_information['name'] = input("what is your name?")
customers_information['street_name'] = input("What is your housenumber and streetname? ")
customers_information['postalcode'] = input("What is the postalcode? ")
customers_information['phonenumber'] = input("What is your phonenumber? ")
print()
print("Thank you for your order {customers_information['name']}. ")
print()
print("We will be delivering your order very shortly thank you for your time")
print()
print(customers_information['street_name'])
print(customers_information['postalcode'])
print()
print("we will contact you on {customers_information['phonenumber']} if anything comes up. ")   
